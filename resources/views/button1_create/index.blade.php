...
<div class="container">
    ...
    <form action="{{ asset('/create') }}" method="post" id="form5" novalidate>
        ...
        <div id="menu1" class="tab-pane fade">
            ...
            <div id="myForm1">
                <h2>借用項目：</h2>
                <select class="form-control" width="auto" name="item[]">
                    <optgroup label="器材">
                ...
                <h2>借用數量：</h2>
                    <select class="form-control" width="auto" name="itemnum[]">
                        <option value="" disabled selected></option>
...
<script language="JavaScript" type="text/javascript">  
     ...
     function selectroom(){
        ...
        if($slc1 == "no"){   
            ...
            $("classroom").find("select[name='classroom']").val().empty();
            $("teacher").find("select[name='teacher']").val().empty();
        }
