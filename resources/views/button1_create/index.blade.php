                ...
                <div class="col-xs-6 col-sm-4">
                    ...
                    <form>
                        <div id="needClassroom">
                            ...
                            <input type="radio" id="needClassroom1" value="yes">Yes
                            <input type="radio" id="needClassroom2" value="no" checked>No
                            </form>
                        </div>
                        
                        <div id="classroom" style="none">
